 ...
 */
$string['pluginname'] = 'Countingdown plugin';
$string['slider:addinstance'] = 'Add a new Countingdown plugin';
$string['slider:myaddinstance'] = 'Add a new Countingdown plugin to the My Moodle page';
$string['header'] = 'Header';
$string['images'] = 'Alternative background image';
